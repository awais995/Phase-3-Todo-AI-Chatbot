...
print("Testing Chatbot Task Response...")
print("="*60)
...
# Step 2: Test general greeting
print(f"\nStep 2: Testing general greeting...")
...
if chat_response.status_code == 200:
    ...
    print("   [OK] Greeting request successful")
    print(f"   Response: '{response_data.get('response', 'NO RESPONSE')}'")
    print(f"   Conversation ID: {response_data.get('conversation_id', 'N/A')}")
else:
    print(f"   [ERROR] Greeting request failed: {chat_response.status_code}")
    print(f"   Response: {chat_response.text}")

# Step 3: Test task addition
print(f"\nStep 3: Testing task addition...")
...
print("If responses are still empty, check the Cohere API configuration.")